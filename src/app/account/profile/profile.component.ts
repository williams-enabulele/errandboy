...
export class ProfileComponent implements OnInit {
  ...
  createProfile(f: NgForm){
    ...
    this.loading = true;
    this.accountService.createProfile(f.value).subscribe(
      res =>
      {
        this.loading = false;
  ...
  updateProfile(f: NgForm){
    console.log(f.value);
    this.loading = true;
    this.accountService.updateProfile(f.value).subscribe(
      res =>
      {
        this.loading = false;
        this.toastr.success("Profile successfully saved");
  ...
  readProfile(){
    this.loading = true;
    this.accountService.readProfile(this.id).subscribe(
      res =>
      {
